...
const otherPlayerPrice = (getTree, allTrees, playerId) => {
  ...
  let treePrice = getTree.leave + NotFreeTreesInCercleTotalLeave * (otherTreesInCercle.length + NotFreeTreesInCercle.length) / NotFreeTreesInCercle.length + playerIdTreesInCercle.length - playerIdTreeInCercleTotalLeave;
